...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    if (req.route?.path?.includes('employees')) {
      ...
      if (documentType.includes('education') || documentType.includes('Certificate') || documentType.includes('Sheet')) {
        uploadPath += 'education/';
      } else if (documentType.includes('document') || documentType.includes('Card') || documentType.includes('Letter')) {
